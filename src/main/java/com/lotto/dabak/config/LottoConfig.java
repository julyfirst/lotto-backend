package com.lotto.dabak.config;
...
@Configuration
@EnableSwagger2
public class LottoConfig implements WebMvcConfigurer {

    private String version = "v1";
    private String pathUri = "/api/v1/**";
    private String title = "Lotto API";
    private String description = "Lotto API Document";
    private String basePackage = "com.lotto.dabak.controller";
